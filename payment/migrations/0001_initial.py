# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-11-06 03:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresaEmpleadora', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='payment.EmpresaEmpleadora')),
            ],
        ),
    ]
